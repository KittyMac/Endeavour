...
public extension EndeavourPamphlet.Private.Figurehead.Ui {
    #if DEBUG
    static func UiButtonHtml() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/figurehead/ui/ui.button.html"
    ...
    #else
    static func UiButtonHtml() -> StaticString {
...
private let uncompressedUiButtonHtml: StaticString = ###"""
...
public extension EndeavourPamphlet.Private.Figurehead.Ui {
    ...
    static func UiGridHtml() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/figurehead/ui/ui.grid.html"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
    ...
    #else
    static func UiGridHtml() -> StaticString {
...
private let uncompressedUiGridHtml: StaticString = ###"""
...
public extension EndeavourPamphlet.Private.Figurehead.Ui {
    ...
    static func UiAllHtml() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/figurehead/ui/ui.all.html"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
    ...
    #else
    static func UiAllHtml() -> StaticString {
...
private let uncompressedUiAllHtml: StaticString = ###"""
...
public extension EndeavourPamphlet.Private.Figurehead.Ui {
    ...
    static func UiAllJs() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/figurehead/ui/ui.all.js"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
    ...
    #else
    static func UiAllJs() -> StaticString {
...
private let uncompressedUiAllJs: StaticString = ###"""
...
public extension EndeavourPamphlet.Private.Figurehead.Ui {
    ...
    static func UiAlertJs() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/figurehead/ui/ui.alert.js"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
    ...
    #else
    static func UiAlertJs() -> StaticString {
...
private let uncompressedUiAlertJs: StaticString = ###"""
...
public extension EndeavourPamphlet.Private.Figurehead.Ui {
    ...
    static func UiAlertHtml() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/figurehead/ui/ui.alert.html"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
    ...
    #else
    static func UiAlertHtml() -> StaticString {
...
private let uncompressedUiAlertHtml: StaticString = ###"""
...
public extension EndeavourPamphlet.Private.Figurehead.Ui {
    ...
    static func UiButtonJs() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/figurehead/ui/ui.button.js"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
    ...
    #else
    static func UiButtonJs() -> StaticString {
...
private let uncompressedUiButtonJs: StaticString = ###"""
