...
public extension EndeavourPamphlet.Private.Endeavour {
    ...
    static func EndeavourStyle() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/endeavour/endeavour.style"
    ...
    #else
    static func EndeavourStyle() -> StaticString {
...
private let uncompressedEndeavourStyle: StaticString = ###"""
...
public extension EndeavourPamphlet.Private.Endeavour {
    ...
    static func EndeavourHtml() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/endeavour/endeavour.html"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
...
public extension EndeavourPamphlet.Private.Endeavour {
    ...
    static func EndeavourJs() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/endeavour/endeavour.js"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
...
public extension EndeavourPamphlet.Private.Endeavour {
    ...
    static func EditorFontsHtml() -> String {
        let fileOnDiskPath = "/Users/rjbowli/Development/chimerasw/Endeavour/Resources/private/endeavour/editor.fonts.html"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
