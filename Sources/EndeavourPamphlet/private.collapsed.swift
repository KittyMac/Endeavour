    ...
    @media (prefers-color-scheme: dark) {
        ...
        *:focus {
        ...
        function handleCreateDocument(xhttp, serviceJson) {
            ...
            ], xhttp.responseText, serviceJson.canWrite == 1, true);
